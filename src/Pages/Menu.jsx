...
//     const size = item.category === "Pizza" ? "Small" : "Standard"; // default size
//     const cartItem = {
//       ...item,
//       size,
//       quantity: 1,
...
//           className="w-full sm:w-1/2 mx-auto block p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
//           value={searchTerm}
...
//       {/* Menu Grid */}
//       <div className="max-w-6xl mx-auto p-4 grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-8">
