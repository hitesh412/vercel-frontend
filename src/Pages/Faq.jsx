...
//       {/* Hero Section */}
//       <div className="bg-orange-500 text-white py-16 text-center px-4">
...
//                 </span>
//                 <span
//                   className={`text-2xl font-bold text-orange-500 transition-transform duration-300 ${
...
//               {openIndex === index && (
//                 <div className="px-5 md:px-6 pb-5 text-gray-600 leading-relaxed text-sm md:text-base">
//                   {faq.answer}
//                 </div>
//               )}
//             </div>
...
//           </p>
//           <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-full shadow">
//             Contact Support
//           </button>
//         </div>
//       </div>
